...
const InputAsSelector = ({
    ...
    return <section className="flex flex-col py-1 my-1 w-full">

        { label && <label className="text-slate-700 mb-1 ml-1 text-base font-medium">{ label }</label> }
        ...
        <input
            className={`
                ...
                focus:ring focus:ring-indigo-400 duration-150
                focus:outline-none
                rounded-md
