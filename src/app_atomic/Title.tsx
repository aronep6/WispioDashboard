...
const PrimaryTitle = ({ children, add = "" }: { children: React.ReactNode, add: string }) => {
...
const SecondaryTitle = ({ children, add = "" }: { children: React.ReactNode, add: string }) => {
...
const TertiaryTitle = ({ children, add = "" }: { children: React.ReactNode, add: string }) => {
...
const BigTitle = ({ children, add = "" }: { children: React.ReactNode, add: string }) => {
    return <h1 className={`dark:text-white tracking-tighter py-2.5 px-1 leading-6 font-bold text-3xl md:text-4xl ${add}`}> {/*text-slate-900*/}
        {children}
    </h1>
};
